...
When I joined the company {ans['time_worked']['years']} years and {ans['time_worked']['months']} months ago as a  {ans['job_title']}, I looked forward to being an impactful team member. Since 
...
Despite the shortcomings, I've really enjoyed the last {ans['time_worked']['months']} months and getting to know the {ans['company_name']} family. I was truly excited 
...
<br>
I’m shocked and disappointed to be laid off by {ans['company_name']}. I have been a key member of the {ans['job_title']} team for {ans['time_worked']['years']} years
and {ans['time_worked']['months']} months now. <br>
<br>
The company’s vision aligns with my values and aspirations, and I anticipated a long and fruitful relationship with {ans['company_name']}.
I have been a committed and dedicated employee since day 1 - being let go like this is unjustified and wrong. My layoff was an 
abrupt shock to an otherwise excellent working relationship - it is not only causing me distress but is also doing harm to my 
