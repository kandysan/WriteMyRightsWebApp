...
When I joined the company"""
    ...
    letter += f"""months ago as a  {ans['job_title']}, I looked forward to being an impactful team member. Since
...
Thank you for the offer of {ans['severance_paid']} weeks of severance. Unfortunately, it falls well below what I am entitled to under prevailing 
...
Given the circumstances, and in the interest of putting this behind us, I would be willing to accept"""
    ...
    letter += f"""Please respond by {ans['response_date']} to indicate your acceptance of the offer. Otherwise, I may be forced to pursue more formal legal action.
